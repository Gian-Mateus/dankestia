...
[![Go Reference](https://pkg.go.dev/badge/github.com/AvengeMedia/Dankestia/core/pkg/go-wayland/wayland.svg)](https://pkg.go.dev/github.com/AvengeMedia/Dankestia/core/pkg/go-wayland/wayland)
...
```sh
CGO_ENABLED=0 go install github.com/AvengeMedia/Dankestia/core/pkg/go-wayland/examples/imageviewer@latest
