...
import (
	...
	"github.com/AvengeMedia/Dankestia/core/internal/colorpicker"
...
Examples:
  dankestia color pick                # Pick color, output as hex
  dankestia color pick --rgb          # Output as RGB
  dankestia color pick --json         # Output all formats as JSON
  dankestia color pick --hex -l       # Output hex in lowercase
  dankestia color pick -a             # Auto-copy result to clipboard`,
	Run: runColorPick,
}
