...
const (
	cliPolicyPackagedPath = "/usr/share/dankestia/cli-policy.json"
	cliPolicyAdminPath    = "/etc/dankestia/cli-policy.json"
)
...
func normalizeCommandSpec(raw string) string {
	...
	normalized = strings.TrimPrefix(normalized, "dankestia ")
...
// $DANKESTIA_PRIVESC env var isn't set).
