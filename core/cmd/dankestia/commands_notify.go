...
import (
	...
	"github.com/AvengeMedia/Dankestia/core/internal/notify"
...
Examples:
  dankestia notify "Hello" "World"
  dankestia notify "File received" "photo.jpg" --file ~/Downloads/photo.jpg --icon smartphone
  dankestia notify "Download complete" --file ~/Downloads/file.zip --app "My App"`,
...
func init() {
	notifyCmd.Flags().StringVar(&notifyAppName, "app", "DANKESTIA", "Application name")
