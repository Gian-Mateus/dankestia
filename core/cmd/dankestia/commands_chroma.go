...
Examples:
  dankestia chroma main.go
  dankestia chroma --language python script.py
  echo "def foo(): pass" | dankestia chroma -l python
  cat code.rs | dankestia chroma -l rust --style dracula
  dankestia chroma --markdown README.md
  dankestia chroma --markdown --style github-dark notes.md
  dankestia chroma list-languages
  dankestia chroma list-styles`,
