...
func init() {
	...
	runCmd.Flags().String("log-level", "", "Log level: debug, info, warn, error, fatal (overrides DANKESTIA_LOG_LEVEL)")
	runCmd.Flags().String("log-file", "", "Append logs to this file in addition to stderr (overrides DANKESTIA_LOG_FILE)")
