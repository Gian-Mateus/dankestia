...
// GetCurrentVersion provides a mock function with given fields: dankestiaPath
func (_m *MockVersionFetcher) GetCurrentVersion(dankestiaPath string) (string, error) {
	ret := _m.Called(dankestiaPath)
...
//   - dankestiaPath string
func (_e *MockVersionFetcher_Expecter) GetCurrentVersion(dankestiaPath interface{}) *MockVersionFetcher_GetCurrentVersion_Call {
	return &MockVersionFetcher_GetCurrentVersion_Call{Call: _e.mock.On("GetCurrentVersion", dankestiaPath)}
}

func (_c *MockVersionFetcher_GetCurrentVersion_Call) Run(run func(dankestiaPath string)) *MockVersionFetcher_GetCurrentVersion_Call {
...
// GetLatestVersion provides a mock function with given fields: dankestiaPath
func (_m *MockVersionFetcher) GetLatestVersion(dankestiaPath string) (string, error) {
	ret := _m.Called(dankestiaPath)
...
//   - dankestiaPath string
func (_e *MockVersionFetcher_Expecter) GetLatestVersion(dankestiaPath interface{}) *MockVersionFetcher_GetLatestVersion_Call {
	return &MockVersionFetcher_GetLatestVersion_Call{Call: _e.mock.On("GetLatestVersion", dankestiaPath)}
}

func (_c *MockVersionFetcher_GetLatestVersion_Call) Run(run func(dankestiaPath string)) *MockVersionFetcher_GetLatestVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
