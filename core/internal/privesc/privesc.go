...
const EnvVar = "DANKESTIA_PRIVESC"
...
// EnvOverride returns the tool selected by the $DANKESTIA_PRIVESC env var (if any)
...
// than one is installed and $DANKESTIA_PRIVESC is not set. If stdin is not a TTY,
