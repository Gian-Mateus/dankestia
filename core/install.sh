...
LATEST_VERSION=$(curl -s https://api.github.com/repos/AvengeMedia/Dankestia/releases/latest | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
...
curl -L "https://github.com/AvengeMedia/Dankestia/releases/download/$LATEST_VERSION/dankinstall-$ARCH.gz" -o "installer.gz"
curl -L "https://github.com/AvengeMedia/Dankestia/releases/download/$LATEST_VERSION/dankinstall-$ARCH.gz.sha256" -o "expected.sha256"
