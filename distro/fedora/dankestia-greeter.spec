# Spec for DANKESTIA Greeter - Stable releases
...
chown -R greeter:greeter %{_localstatedir}/cache/dankestia-greeter 2>/dev/null || true
...
2. Sync your theme with the greeter (optional):
     If you have Dankestia (DANKESTIA) installed, you can sync theming with:
