        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                WrappedLoader {
                    ...
                    active: Config.dashboard.performance.showGpu && Gpu.type !== Gpu.typeNone
